...
const clerkAppearance = {
  ...
  variables: {
    colorPrimary: "hsl(220, 100%, 56%)",
    colorForeground: "hsl(215, 27%, 90%)",
    colorMutedForeground: "hsl(222, 19%, 51%)",
    colorDanger: "hsl(348, 100%, 65%)",
    colorBackground: "hsl(224, 28%, 11%)",
    colorInput: "hsl(224, 28%, 14%)",
    colorInputForeground: "hsl(215, 27%, 90%)",
    colorNeutral: "hsl(215, 62%, 24%)",
  ...
  elements: {
    ...
    formFieldInput: "bg-input border-border text-foreground rounded-lg",
  },
};
